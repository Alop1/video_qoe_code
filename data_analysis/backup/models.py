...
import re, os
import pandas as pd
from data_analysis.data_preparation import scale_data
...
class Report(object):
    ...
    def __init__(self):
        ...
        path = "reports/czerwiec_7_res/models_summary_FR100_withresolution_noslice_rbf_noduration.csv"
...
def map_to_polish():
    map_dictionary = {
        ...
        "spatialactivity": u"aktywność przestrzenna",
        "pillarbox": u"pollarbox",
...
def support_vector_regresion_model(training_data, testing_data, *features):
    ...
    x_test = testing_data[list(features)]
    y_test = testing_data["Subject_score"]
    svr = svm.SVR(kernel="rbf", C=0.7) #"linear"
...
def nn_model(training_data, testing_data, *features):
    ...
    nn = MLPRegressor(hidden_layer_sizes=(13,13,13,13), max_iter=50000) # max_iter=500 random_state=9
