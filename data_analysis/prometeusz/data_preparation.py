...
def read_all_csv():
    ...
    pd_DB1 = pd.read_csv(r"/net/archive/groups/plggvideo/VMAF_new/VMAF/data_analysis/DB1.csv", skipinitialspace=True)
    pd_DB_cif = pd.read_csv(r"/net/archive/groups/plggvideo/VMAF_new/VMAF/data_analysis/DB_cif.csv", skipinitialspace=True)
    pd_DB_cif4 = pd.read_csv(r"/net/archive/groups/plggvideo/VMAF_new/VMAF/data_analysis/DB_cif4.csv", skipinitialspace=True)
    pd_india_agh = pd.read_csv(r"/net/archive/groups/plggvideo/VMAF_new/VMAF/data_analysis/india_agh.csv", skipinitialspace=True)
    pd_netflix1 = pd.read_csv(r"/net/archive/groups/plggvideo/VMAF_new/VMAF/data_analysis/netflix1.csv", skipinitialspace=True)
    pd_netflix2 = pd.read_csv(r"/net/archive/groups/plggvideo/VMAF_new/VMAF/data_analysis/netflix2.csv", skipinitialspace=True)
