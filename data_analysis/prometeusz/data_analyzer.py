...
def execute_LR(training_dataset, testing_dataset, features_all, features_test_0, features_test_2,
...
@data_preparation.duration_measurement
def execute_SVR(training_dataset, testing_dataset, features_all, features_test_0, features_test_2,
               agh_features, netflix_features_psnr, netflix_features_nopsnr, features_test_1_dark,
               features_test_2_dark,
               features_all_full, features_test_0_full, features_test_2_full, features_test_3_full,
               agh_features_full, netflix_features_psnr_full, netflix_features_nopsnr_full, features_test_1_dark_full,
...
@data_preparation.duration_measurement
def execute_NN(training_dataset, testing_dataset, features_all, features_test_0, features_test_2,
               agh_features, netflix_features_psnr, netflix_features_nopsnr, features_test_1_dark,
               features_test_2_dark,
               features_all_full, features_test_0_full, features_test_2_full, features_test_3_full,
               agh_features_full, netflix_features_psnr_full, netflix_features_nopsnr_full, features_test_1_dark_full,
...
@data_preparation.duration_measurement
def execute_RF(training_dataset, testing_dataset, features_all, features_test_0, features_test_2,
               agh_features, netflix_features_psnr, netflix_features_nopsnr, features_test_1_dark,
               features_test_2_dark,
               features_all_full, features_test_0_full, features_test_2_full, features_test_3_full,
               agh_features_full, netflix_features_psnr_full, netflix_features_nopsnr_full, features_test_1_dark_full,
...
def main():
    ...
    # todo test z zamiast duration to fps vs frames number
    # todo inny kernel
    features_all_full = ["PSNR", "Aggregate_vmaf", "SSIM", "MS_SSIM", "blockiness",
                         ...
                         "blockout", "exposure", "contrast", "brightness",
                          "1920x1080", "352x288", "3840x2160", "640x480", "704x576",
                         'one_res',"duration"]
    features_test_0_full = ["PSNR", "Aggregate_vmaf", "SSIM", "MS_SSIM", "blockiness", "1920x1080", "352x288",
                            "3840x2160", "640x480", "704x576", 'one_res']
    ...
    features_test_1_dark_full = ["duration", "PSNR", "Aggregate_vmaf", "SSIM", "MS_SSIM", "1920x1080", "352x288",
                                 "3840x2160", "640x480", "704x576", 'brightness',  'one_res']
    features_test_2_dark_full = ["duration", "PSNR", "Aggregate_vmaf", "SSIM", "MS_SSIM", "1920x1080", "352x288",
                                 "3840x2160", "640x480", "704x576", 'brightness', 'exposure', 'one_res']

    # BEZ resolution_quantity
    features_all = ["PSNR", "Aggregate_vmaf", "SSIM", "MS_SSIM", "blockiness",
                    "spatialactivity", "pillarbox", "blockloss", "blur", "temporalact",
                    "blockout", "exposure", "contrast", "brightness",
                     "fps", "1920x1080", "352x288", "3840x2160", "640x480", "704x576", "duration"]
    features_test_0 = [ "PSNR", "Aggregate_vmaf", "SSIM", "MS_SSIM", "blockiness", "1920x1080", "352x288",
    ...
    execute_LR(training_dataset, testing_dataset, features_all, features_test_0, features_test_2,
               agh_features, netflix_features_psnr, netflix_features_nopsnr, features_test_1_dark,
               features_test_2_dark,
               features_all_full, features_test_0_full, features_test_2_full, features_test_3_full,
               agh_features_full, netflix_features_psnr_full, netflix_features_nopsnr_full, features_test_1_dark_full,
    ...
    execute_SVR(training_dataset, testing_dataset, features_all, features_test_0, features_test_2,
               agh_features, netflix_features_psnr, netflix_features_nopsnr, features_test_1_dark,
               features_test_2_dark,
               features_all_full, features_test_0_full, features_test_2_full, features_test_3_full,
               agh_features_full, netflix_features_psnr_full, netflix_features_nopsnr_full, features_test_1_dark_full,
    ...
    execute_NN(training_dataset, testing_dataset, features_all, features_test_0, features_test_2,
               agh_features, netflix_features_psnr, netflix_features_nopsnr, features_test_1_dark,
               features_test_2_dark,
               features_all_full, features_test_0_full, features_test_2_full, features_test_3_full,
               agh_features_full, netflix_features_psnr_full, netflix_features_nopsnr_full, features_test_1_dark_full,
    ...
    execute_RF(training_dataset, testing_dataset, features_all, features_test_0, features_test_2,
               agh_features, netflix_features_psnr, netflix_features_nopsnr, features_test_1_dark,
               features_test_2_dark,
               features_all_full, features_test_0_full, features_test_2_full, features_test_3_full,
               agh_features_full, netflix_features_psnr_full, netflix_features_nopsnr_full, features_test_1_dark_full,
